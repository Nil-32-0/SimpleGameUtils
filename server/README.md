...
Run install.sh or install.bat depending on your operating system. This will run a setup script that allows you to determine what you wish to set up. On a first install, you typically should answer yes to all parts. You will need to include a library folder for whatever game you are setting the server up for in the /library/ folder in the same directory as the installer, and provide the name of that library when prompted for it.
